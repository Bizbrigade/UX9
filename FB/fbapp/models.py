...
class Home_Details(models.Model):
    logo=models.ImageField(upload_to="images/",default='#', max_length = 500)
    banner2=models.ImageField(upload_to="images/",default='#', max_length = 500)
    banner3=models.ImageField(upload_to="images/",default='#', max_length = 500)
...
class about_sec(models.Model):
    ...
    about_banner=models.ImageField(upload_to="images/about/",default='#', max_length = 500)
...
class blog(models.Model):
    ...
    blog_image=models.ImageField(upload_to="images/blog/",default='#', max_length = 500)
...
class review(models.Model):
    ...
    review_image=models.ImageField(upload_to="images/review/",default='#', max_length = 500)
...
class category(models.Model):
    ...
    category_banner_image=models.ImageField(upload_to="images/category/",default='#', max_length = 500)
    category_home_image=models.ImageField(upload_to="images/category/",default='#', max_length = 500)
    logs             = models.TextField(default='#')
...
class brand(models.Model):
    ...
    brand_logo=models.ImageField(upload_to="images/brand/",default='#', max_length = 500)
...
class Articles(models.Model):
    ...
    article_img=models.ImageField(upload_to="images/blog/",default='#', max_length = 500)
    created_at = models.DateTimeField(auto_now_add=True)
